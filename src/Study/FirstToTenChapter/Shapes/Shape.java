...
class Circle extends Shape {
        @Override
        public void draw(){
                System.out.println("Study.FirstToTenChapter.Shapes.draw()");
        }
        @Override
        public void erase(){
                System.out.println("Study.FirstToTenChapter.Shapes.erase()");
        }

        @Override
        public void amed() {
                System.out.println("Study.FirstToTenChapter.Shapes.amed()");
        }
}
