...
class FuelFilter extends Filter{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<FuelFilter>{
        public FuelFilter create(){return new FuelFilter();}
    }
}

class AirFilter extends Filter{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<AirFilter>{
        public AirFilter create(){return new AirFilter();}
    }
}

class CabinAirFilter extends Filter{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<CabinAirFilter>{
        public CabinAirFilter create(){return new CabinAirFilter();}
    }
}

class OilFilter extends Filter{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<OilFilter>{
...
class FanBelt extends Belt{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<FanBelt>{
        public FanBelt create(){return new FanBelt();}
    }
}

class GeneratorBelt extends Belt{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<GeneratorBelt>{
        public GeneratorBelt create(){return new GeneratorBelt();}
    }
}

class PowerSteeringBelt extends Belt{
    public static class Factory implements Study.TenToTwentyChapter.typeinfo.Factory<PowerSteeringBelt>{
